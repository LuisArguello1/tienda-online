...
const Registro_user = () => {
  ...
  const [ContrasenaUsuarioRegistro, setContrasenaUsuarioRegistro] =
    useState("");
  ...
  useEffect(() => {
    const productoExistentes = JSON.parse(
      localStorage.getItem("listaProductos")
    );
    if (!productoExistentes || productoExistentes.length === 0) {
      ...
      // Si ya existen productos en el localStorage, cargarlos en el estado
      setListaProductos(productoExistentes);
    }
  }, []);
  ...
  return (
    <>
            ...
            <div className="contenedor-inicionSesion">
              <div className="background-inicioSesion">
                ...
                <div className="contenedor-button">
                  <button
                    className="button"
                    onClick={() => rellenarDatos(false, true)}
                  >
      ...
      {MostrarProductos && (
        <Productos
          esAdmin={DatoAdministrativo}
          nombreUsuario={UsuarioMostrar}
